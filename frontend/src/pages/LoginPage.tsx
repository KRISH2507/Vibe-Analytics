...
import { generateLoginOTP } from '@/api/auth';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right side - Visual */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary/5 via-accent/5 to-background items-center justify-center p-12">
        <motion.div
        ...
        >
          <div className="w-24 h-24 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-accent to-primary flex items-center justify-center glow-effect">
          ...
          <p className="text-muted-foreground">
            Track what the world is saying about any topic, brand, or keyword across all major social platforms.
          </p>
        </motion.div>
      </div>
    </div>
